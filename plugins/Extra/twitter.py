...
async def twitter_handler(Client, message):
   try:            
      ...
      try:
          dump_file = await message.reply_video(link,caption="Thank you for using - @TamilMovies6K")
          ...
          try:
             ...
             await snd_message.delete()
              ...
              try:
                  dump_file = await message.reply_video(content_value,caption="Thank you for using - @TamilMovies6K")
              except Exception as e:
                  print(e)
                  try:
                     snd_msg=await message.reply(content_value)
                     await asyncio.sleep(1)
                     await message.reply_video(content_value,caption="Thank you for using - @TamilMovies6K")
       ...
       await m.delete()
       await message.reply("Check out @TamilMovies6K (music)  @TamilBots(Channel) \n Please Support Us By /donate To Maintain This Project")               
