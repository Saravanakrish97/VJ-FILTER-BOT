...
BOT_TOKEN = environ.get('BOT_TOKEN', "5243321817:AAGpsYRij1TM6OVc8TD0ynXYL8J0_HkXRX8")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001575521444 -1001831261465 -1002109559685 -1002134479029 -1002225923778 -1002068765207 -1002907646977').split()]
...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002352846671').split() if id_pattern.search(auth_channel)]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TamilMovies6k')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/tamilmoviechat/28')
