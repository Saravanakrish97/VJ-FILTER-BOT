...
Join My <a href='https://telegram.dog/TamilBots'>Update Channel</a> For More Update Regarding Repo.</b>
...
* `DATABASE_URI`: [mongoDB](https://www.mongodb.com) URI. Get this value from [mongoDB](https://www.mongodb.com). For more help watch this [video](https://youtu.be/TamilBots)
...
* Check [info.py](https://github.com/VJBots/Tamil-Filter-Bot/blob/TamilBots/info.py) for more optional variables.</b>


<details><summary><b>Deploy To Heroku</b></summary>
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/TamilBots/Tamil-Filter-Bot">
...
[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=git&repository=github.com/TamilBots/Tamil-Filter-Bot&branch=TamilBots&name=Tamil-Filter-Bot)
</details>
...
<br>
<br>
<a href="https://render.com/deploy?repo=https://github.com/TamilBots/Tamil-Filter-Bot/tree/TamilBots">
...
`git clone https://github.com/TamilBots/Tamil-Filter-Bot`
...
## Thanks to 
 ...
 - Thanks To [Tech VJ](https://t.me/Tech_VJ)
 - Thanks To [Saravanakrish](https://t.me/imsaravanakrish)
 - Thanks To All Everyone In This Journey</b>

## Note 🏷️
 
* [![Contact Developer](https://img.shields.io/static/v1?label=Contact+Developer&message=On+Telegram&color=critical)](https://telegram.me/TamilBots)
...
<b>Licensed under [GNU AGPL 2.0.](https://github.com/TamilBots/Tamil-Filter-Bot/blob/TamilBots/LICENSE)
